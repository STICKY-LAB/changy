...
export default function hasOwnProperty(this : Object, prop : Primitive<PropertyKey>) : Primitive<boolean> {
    const result = new Primitive(OriginalObject.prototype.hasOwnProperty.call(this[O], prop[O].value));
    const listeners = {
    ...
    const propListeners = {
        set:(value : PropertyKey) => {
            result.set(OriginalObject.prototype.hasOwnProperty.call(this[O], value));
        }
    };
